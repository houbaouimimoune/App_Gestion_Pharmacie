...
public class LoginPage {
	...
	static String dernierConnectName;
	...
	public void login() {
		try {
			...
			PreparedStatement pst= con.prepareStatement("select * from users where user_name = ? and user_password = ?");
			pst.setString(1, txtUserName.getText());
			pst.setString(2, txtPassWord.getText());
			dernierConnectName = txtUserName.getText();
	...
	private void initialize() {
		...
		btnNewButton.setBounds(162, 472, 204, 23);
		...
		lblNewLabel_1.setBounds(219, 0, 127, 77);
