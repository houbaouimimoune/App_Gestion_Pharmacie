	...
	private void initialize() {
		...
		panel_2.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				espaceAdmin.frame.setVisible(true);
			}
		});
		panel_2.setBounds(327, 191, 103, 44);
		panel_1.add(panel_2);
		panel_2.setLayout(null);
		
		JLabel lblNewLabel_2 = new JLabel("Espace admin");
		...
		panel_2_2.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				EspaceUsers espaceUsers = new EspaceUsers();
				espaceUsers.frame.setVisible(true);
			}
		});
		panel_2_2.setBounds(517, 191, 103, 44);
		panel_1.add(panel_2_2);
		panel_2_2.setLayout(null);
		
		JLabel lblNewLabel_2_1 = new JLabel("Espace utilisatuer");
		lblNewLabel_2_1.setBounds(10, 11, 93, 14);
